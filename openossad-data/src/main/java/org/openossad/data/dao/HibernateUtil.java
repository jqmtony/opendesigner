...
public class HibernateUtil {
    ...
    private static String configFromConfPath = System.getProperty("user.dir").
//      private static String configFromConfPath = new String("/home/fjhidalgo/workspace_sandbox/googlecode/opendesigner").

//            concat(File.separator).concat("..").
            concat(File.separator).concat("conf").
            concat(File.separator).concat("hibernate.cfg.xml");
    ...
    static {
        ...
        try {
            ...
            //configuration.configure(configFromConfPath);
