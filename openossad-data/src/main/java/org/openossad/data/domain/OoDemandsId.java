...
/**
 * OoDemandsId generated by hbm2java
 */
public class OoDemandsId implements java.io.Serializable {
	...
	public OoDemandsId(int ddemandeur, int ddestinataire, int dtypeElement,
	...
	public OoDemandsId(Integer did, int ddemandeur, int ddestinataire,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OoDemandsId))
			return false;
		OoDemandsId castOther = (OoDemandsId) other;
