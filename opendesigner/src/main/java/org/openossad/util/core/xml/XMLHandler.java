...
package org.openossad.util.core.xml;
...
import org.openossad.util.core.exception.OpenDESIGNERXMLException;
import org.openossad.util.core.row.ValueMeta;
...
public class XMLHandler
{
     ...
     */
    public static final Document loadXMLFile(String filename) throws OpenDESIGNERXMLException
    {
        try
        {
            return loadXMLFile(OpenDESIGNERVFS.getFileObject(filename));
        }
        catch(IOException e)
        {
            throw new OpenDESIGNERXMLException(e);
        }
    }
     ...
     */
    public static final Document loadXMLFile(FileObject fileObject) throws OpenDESIGNERXMLException
    {
    ...
    public static final Document loadXMLFile(File resource) throws OpenDESIGNERXMLException
	{
    	try
    	{
	 ...
	 * @return the Document if all went well, null if an error occured!
	 */
	public static final Document loadXMLFile(URL resource) throws OpenDESIGNERXMLException
	{
	    DocumentBuilderFactory dbf;
		DocumentBuilder db;
		Document doc;
		...
		{
			throw new OpenDESIGNERXMLException("Error reading information from resource", e);
		}
	}
	...
	public static final Document loadXMLString(String string) throws OpenDESIGNERXMLException
	{
		...
		{
			throw new OpenDESIGNERXMLException("Error reading information from XML string : "+Const.CR+string, e);
		}
	}
