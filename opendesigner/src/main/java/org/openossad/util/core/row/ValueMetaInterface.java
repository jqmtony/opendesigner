...
public interface ValueMetaInterface extends Cloneable
{
     ...
     * @throws OpenDESIGNERFileException in case a I/O error occurs
     */
     ...
     * @throws OpenDESIGNERFileException in case a I/O error occurs
     * @throws OpenDESIGNEREOFException When we have read all the data there is to read
     ...
     */
    public Object convertDataUsingConversionMetaData(Object data) throws OpenDESIGNERValueException;
    /**
     ...
     * @throws OpenDESIGNERValueException in case there is a data conversion problem 
     */
