package org.openossad.util.core;
...
import org.openossad.util.core.row.ValueMetaInterface;
import org.openossad.util.core.laf.BasePropertyHandler;
...
public class Const
{
    ...
    */
     ...
     */
    public static final ClassLoader createNewClassLoader() throws OpenDESIGNERException
    {
        try
        {
        ...
        {
            throw new OpenDESIGNERException("Unexpected error during classloader creation", e);
        }
    }
