 ...
 *
 */
public class OpenDESIGNERFileException extends OpenDESIGNERException
{
	 ...
	 */
	public OpenDESIGNERFileException()
	{
		super();
	}
	 ...
	 */
	public OpenDESIGNERFileException(String message)
	{
		super(message);
	}
	 ...
	 */
	public OpenDESIGNERFileException(Throwable cause)
	{
		super(cause);
	}
	 ...
	 * @param cause the cause (which is saved for later retrieval by the getCause() method). (A null value is permitted, and indicates that the cause is nonexistent or unknown.)
	 */
	public OpenDESIGNERFileException(String message, Throwable cause)
	{
		super(message, cause);
	}
