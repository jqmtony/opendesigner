 ...
 *
 */
public class OpenDESIGNEREOFException extends OpenDESIGNERFileException
{
	 ...
	 */
	public OpenDESIGNEREOFException()
	{
		super();
	}
	 ...
	 */
	public OpenDESIGNEREOFException(String message)
	{
		super(message);
	}
	 ...
	 */
	public OpenDESIGNEREOFException(Throwable cause)
	{
		super(cause);
	}
	 ...
	 * @param cause the cause (which is saved for later retrieval by the getCause() method). (A null value is permitted, and indicates that the cause is nonexistent or unknown.)
	 */
	public OpenDESIGNEREOFException(String message, Throwable cause)
	{
		super(message, cause);
	}
