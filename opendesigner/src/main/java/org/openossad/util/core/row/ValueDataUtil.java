...
public class ValueDataUtil
{
     ...
     * A character is considered a space in OpenDESIGNER if it is a space, a tab, a newline or a cariage return.
    ...
    public static Object plus(ValueMetaInterface metaA, Object dataA, ValueMetaInterface metaB, Object dataB) throws OpenDESIGNERValueException
    {
        if (dataA==null || dataB==null) return null;
        ...
        default: throw new OpenDESIGNERValueException("The 'plus' function only works on numeric data and Strings." );
        }
    }
    public static Object plus3(ValueMetaInterface metaA, Object dataA, ValueMetaInterface metaB, Object dataB, ValueMetaInterface metaC, Object dataC) throws OpenDESIGNERValueException
    {
    ...
    public static Object sum(ValueMetaInterface metaA, Object dataA, ValueMetaInterface metaB, Object dataB) throws OpenDESIGNERValueException
    {
        if (dataA==null && dataB==null) return null;
    ...
    public static Object loadFileContentInBinary(ValueMetaInterface metaA, Object dataA) throws OpenDESIGNERValueException
    {
        if (dataA==null) return null;
    ...
    public static Object minus(ValueMetaInterface metaA, Object dataA, ValueMetaInterface metaB, Object dataB) throws OpenDESIGNERValueException
    {
        if (dataA==null || dataB==null) return null;
        ...
        default: throw new OpenDESIGNERValueException("The 'minus' function only works on numeric data." );
        }
    }

    public static Object multiply(ValueMetaInterface metaA, Object dataA, ValueMetaInterface metaB, Object dataB) throws OpenDESIGNERValueException
    {
        if (dataA==null || dataB==null) return null;
        ...
        default: throw new OpenDESIGNERValueException("The 'multiply' function only works on numeric data optionally multiplying strings." );
        }
    }

    public static Object divide(ValueMetaInterface metaA, Object dataA, ValueMetaInterface metaB, Object dataB) throws OpenDESIGNERValueException
    {
        if (dataA==null || dataB==null) return null;
        ...
        default: throw new OpenDESIGNERValueException("The 'divide' function only works on numeric data." );
        }
    }
    
    public static Object sqrt(ValueMetaInterface metaA, Object dataA) throws OpenDESIGNERValueException
    {
        if (dataA==null) return null;
     ...
     */
    public static Object percent1(ValueMetaInterface metaA, Object dataA, ValueMetaInterface metaB, Object dataB) throws OpenDESIGNERValueException
    {
        if (dataA==null || dataB==null) return null;
        ...
        default: throw new OpenDESIGNERValueException("The 'A/B in %' function only works on numeric data" );
        }
    }
     ...
     * @throws OpenDESIGNERValueException
     */
    public static Object percent2(ValueMetaInterface metaA, Object dataA, ValueMetaInterface metaB, Object dataB) throws OpenDESIGNERValueException
    {
        if (dataA==null || dataB==null) return null;
        ...
        default: throw new OpenDESIGNERValueException("The 'A-B%' function only works on numeric data" );
        }
    }
     ...
     * @throws OpenDESIGNERValueException
     */
    public static Object percent3(ValueMetaInterface metaA, Object dataA, ValueMetaInterface metaB, Object dataB) throws OpenDESIGNERValueException
    {
        if (dataA==null || dataB==null) return null;
     ...
     * @throws OpenDESIGNERValueException
     */
    public static Object combination1(ValueMetaInterface metaA, Object dataA, ValueMetaInterface metaB, Object dataB, ValueMetaInterface metaC, Object dataC) throws OpenDESIGNERValueException
    {
        if (dataA==null || dataB==null || dataC==null) return null;
        ...
        default: throw new OpenDESIGNERValueException("The 'combination1' function only works on numeric data" );
        }
    }
     ...
     * @throws OpenDESIGNERValueException
     */
    public static Object combination2(ValueMetaInterface metaA, Object dataA, ValueMetaInterface metaB, Object dataB) throws OpenDESIGNERValueException
    {
        if (dataA==null || dataB==null) return null;
        ...
        default: throw new OpenDESIGNERValueException("The 'combination2' function only works on numeric data" );
        }
    }
    
    public static Object round(ValueMetaInterface metaA, Object dataA) throws OpenDESIGNERValueException
    {
        if (dataA==null) return null;
        ...
        default: throw new OpenDESIGNERValueException("The 'round' function only works on numeric data" );
        }
    }
    public static Object abs(ValueMetaInterface metaA, Object dataA) throws OpenDESIGNERValueException
    {
        if (dataA==null) return null;
        ...
        default: throw new OpenDESIGNERValueException("The 'abs' function only works on numeric data" );
        }
    }
    
    public static Object round(ValueMetaInterface metaA, Object dataA, ValueMetaInterface metaB, Object dataB) throws OpenDESIGNERValueException
    {
        if (dataA==null || dataB==null) return null;
    ...
    public static Object nvl(ValueMetaInterface metaA, Object dataA, ValueMetaInterface metaB, Object dataB) throws OpenDESIGNERValueException
    {
        switch(metaA.getType())
        {
        case ValueMetaInterface.TYPE_STRING: 
        ...
        default: throw new OpenDESIGNERValueException("The 'nvl' function doesn't know how to handle data type "+metaA.getType() );
        }
    }
    public static Object removeTimeFromDate(ValueMetaInterface metaA, Object dataA) throws OpenDESIGNERValueException
    {
        if (metaA.isDate())
        {
        ...
        throw new OpenDESIGNERValueException("The 'removeTimeFromDate' function only works with a date");
    }
    ...
    throws OpenDESIGNERValueException
    {
        ...
        if (metaA.isDate())
        {
        	...
        	}catch(Exception e) {throw new OpenDESIGNERValueException(e);}
        }

        throw new OpenDESIGNERValueException("The 'addTimeToDate' function only works with a date");
    }
    public static Object addDays(ValueMetaInterface metaA, Object dataA, ValueMetaInterface metaB, Object dataB) throws OpenDESIGNERValueException
    {
        ...
        throw new OpenDESIGNERValueException("The 'addDays' function only works with a date and an integer");
    }
    public static Object DateDiff(ValueMetaInterface metaA, Object dataA, ValueMetaInterface metaB, Object dataB) throws OpenDESIGNERValueException
    {
        ...
        throw new OpenDESIGNERValueException("The 'DateDiff' function only works with dates");
    }
    public static Object yearOfDate(ValueMetaInterface metaA, Object dataA) throws OpenDESIGNERValueException
    {
        if (dataA==null) return null;
        ...
        throw new OpenDESIGNERValueException("The 'yearOfDate' function only works with dates");
    }
    
    public static Object monthOfDate(ValueMetaInterface metaA, Object dataA) throws OpenDESIGNERValueException
    {
        if (dataA==null) return null;
        ...
        throw new OpenDESIGNERValueException("The 'monthOfDate' function only works with dates");
    }
    
    public static Object dayOfYear(ValueMetaInterface metaA, Object dataA) throws OpenDESIGNERValueException
    {
        if (dataA==null) return null;
        ...
        throw new OpenDESIGNERValueException("The 'dayOfYear' function only works with dates");
    }
    
    public static Object dayOfMonth(ValueMetaInterface metaA, Object dataA) throws OpenDESIGNERValueException
    {
        if (dataA==null) return null;
        ...
        throw new OpenDESIGNERValueException("The 'dayOfMonth' function only works with dates");
    }
    
    public static Object dayOfWeek(ValueMetaInterface metaA, Object dataA) throws OpenDESIGNERValueException
    {
        if (dataA==null) return null;
        ...
        throw new OpenDESIGNERValueException("The 'dayOfWeek' function only works with dates");
    }
    ...
    public static Object weekOfYearISO8601(ValueMetaInterface metaA, Object dataA) throws OpenDESIGNERValueException
    {
        if (dataA==null) return null;
    ...
    public static Object yearOfDateISO8601(ValueMetaInterface metaA, Object dataA) throws OpenDESIGNERValueException
    {
        if (dataA==null) return null;
     ...
     * @throws OpenDESIGNERValueException  
     */    
    public static String hexToByteDecode(ValueMetaInterface meta, Object data) throws OpenDESIGNERValueException 
    {
        if (meta.isNull(data)) 
        {           
            return null;
     ...
     * @throws OpenDESIGNERValueException
     */
    public static String byteToHexEncode(ValueMetaInterface metaA, Object dataA) throws OpenDESIGNERValueException
    {
        if (dataA==null) return null;
     ...
     * @throws OpenDESIGNERValueException In case of a data conversion problem.
     */
    public static String charToHexEncode(ValueMetaInterface meta, Object data) throws OpenDESIGNERValueException
    {
     ...
     * @throws OpenDESIGNERValueException  
     */    
    public static String hexToCharDecode(ValueMetaInterface meta, Object data) throws OpenDESIGNERValueException 
    {
        if (meta.isNull(data)) 
        {           
            return null;
