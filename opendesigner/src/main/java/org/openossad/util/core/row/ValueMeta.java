...
*/
package org.openossad.util.core.row;
...
import org.openossad.util.core.compatibility.Value;
...
public class ValueMeta implements ValueMetaInterface
{
    ...
    private synchronized Date convertStringToDate(String string) throws OpenDESIGNERValueException
    {
        ...
        catch (ParseException e)
        {
            ...
            throw new OpenDESIGNERValueException(toString()+" : couldn't convert string ["+string+"] to a date using format ["+dateFormat+"]", e);
        }
    }
    ...
    private synchronized String convertNumberToString(Double number) throws OpenDESIGNERValueException
    {
        if (number==null) {
        ...
        {
            throw new OpenDESIGNERValueException(toString()+" : couldn't convert Number to String ", e);
        }
    }
    
    private synchronized String convertNumberToCompatibleString(Double number) throws OpenDESIGNERValueException
    {
        if (number==null) return null;
        return Double.toString(number);
    }
    
    private synchronized Double convertStringToNumber(String string) throws OpenDESIGNERValueException
    {
        string = Const.trimToType(string, getTrimType()); // see if  trimming needs to be performed before conversion
        ...
        {
            throw new OpenDESIGNERValueException(toString()+" : couldn't convert String to number ", e);
        }
    }
    ...
    private synchronized String convertIntegerToString(Long integer) throws OpenDESIGNERValueException
    {
        if (integer==null) {
        	if (!outputPaddingEnabled || length<1) {
        		return null;
        ...
        {
            throw new OpenDESIGNERValueException(toString()+" : couldn't convert Long to String ", e);
        }
    }
    
    private synchronized String convertIntegerToCompatibleString(Long integer) throws OpenDESIGNERValueException
    {
        if (integer==null) return null;
        return Long.toString(integer);
    }
    
    private synchronized Long convertStringToInteger(String string) throws OpenDESIGNERValueException
    {
        string = Const.trimToType(string, getTrimType()); // see if  trimming needs to be performed before conversion
        ...
        {
            throw new OpenDESIGNERValueException(toString()+" : couldn't convert String to Integer", e);
        }
    }
    
    private synchronized String convertBigNumberToString(BigDecimal number) throws OpenDESIGNERValueException
    {
        if (number==null) return null;
        ...
        {
            throw new OpenDESIGNERValueException(toString()+" : couldn't convert BigNumber to String ", e);
        }
    }
    
    private synchronized BigDecimal convertStringToBigNumber(String string) throws OpenDESIGNERValueException
    {
        string = Const.trimToType(string, getTrimType()); // see if  trimming needs to be performed before conversion
        ...
        catch(Exception e)
        {
            ...
            {
            	throw new OpenDESIGNERValueException(toString()+" : couldn't convert string value '" + string + "' to a big number.", ex);
            }
        }
}
     ...
     */
    private String convertBinaryStringToString(byte[] binary) throws OpenDESIGNERValueException
    {
        ...
        else
        {
            ...
            {
                throw new OpenDESIGNERValueException(toString()+" : couldn't convert binary value to String with specified string encoding ["+stringEncoding+"]", e);
            }
        }
    }
     ...
     * @throws OpenDESIGNERValueException In case there is a data conversion error.
     */
    public Object convertToNormalStorageType(Object object) throws OpenDESIGNERValueException
    {
        ...
        default: 
        	throw new OpenDESIGNERValueException(toStringMeta()+" : Unknown storage type ["+storageType+"] while converting to normal storage type");
    	}
    }
     ...
     * @throws OpenDESIGNERValueException In case there is a data conversion error.
     */
    public Object convertToBinaryStringStorageType(Object object) throws OpenDESIGNERValueException
    {
    	if (object==null) return null;
     ...
     * @throws OpenDESIGNERValueException
     */
    public Object convertBinaryStringToNativeType(byte[] binary) throws OpenDESIGNERValueException
    {
    ...
    public Object convertNormalStorageTypeToBinaryString(Object object) throws OpenDESIGNERValueException
    {
    	if (object==null) return null;
    ...
    private byte[] convertStringToBinaryString(String string) throws OpenDESIGNERValueException
    {
        ...
        else
        {
            ...
            {
                throw new OpenDESIGNERValueException(toString()+" : couldn't convert String to Binary with specified string encoding ["+stringEncoding+"]", e);
            }
        }
    }
     ...
     */
    public Object cloneValueData(Object object) throws OpenDESIGNERValueException
    {
        if (object==null) return null;
        ...
        if (storageType==STORAGE_TYPE_NORMAL)
        {
            ...
            default: throw new OpenDESIGNERValueException(toString()+": unable to make copy of value type: "+getType());
            }
        }
        else {
    ...
    public String getCompatibleString(Object object) throws OpenDESIGNERValueException
    {
        try
        {
            String string;
            ...
            case TYPE_DATE:
                ...
                default: throw new OpenDESIGNERValueException(toString()+" : Unknown storage type "+storageType+" specified.");
                }
                break;
        ...
        {
        	throw new OpenDESIGNERValueException(toString()+" : There was a data type error: the data type of "+object.getClass().getName()+" object ["+object+"] does not correspond to value meta ["+toStringMeta()+"]");
        }
    }

    public String getString(Object object) throws OpenDESIGNERValueException
    {
        try
        {
            String string;
            ...
            default: 
                throw new OpenDESIGNERValueException(toString()+" : Unknown type "+type+" specified.");
            }
	...
	public Double getNumber(Object object) throws OpenDESIGNERValueException
    {
		try
		{
	        if (object==null) // NULL 
	        ...
	        case TYPE_BINARY:
	            throw new OpenDESIGNERValueException(toString()+" : I don't know how to convert binary values to numbers.");
	        case TYPE_SERIALIZABLE:
	            throw new OpenDESIGNERValueException(toString()+" : I don't know how to convert serializable values to numbers.");
	        default:
	            throw new OpenDESIGNERValueException(toString()+" : Unknown type "+type+" specified.");
	        }
    	}
    	...
    	{
    		throw new OpenDESIGNERValueException("Unexpected conversion error while converting value ["+toString()+"] to a Number", e);
    	}
    }

    public Long getInteger(Object object) throws OpenDESIGNERValueException
    {
    	try
    	{
	        if (object==null) // NULL 
	        ...
	        case TYPE_BINARY:
	            throw new OpenDESIGNERValueException(toString()+" : I don't know how to convert binary values to integers.");
	        case TYPE_SERIALIZABLE:
	            throw new OpenDESIGNERValueException(toString()+" : I don't know how to convert serializable values to integers.");
	        default:
	            throw new OpenDESIGNERValueException(toString()+" : Unknown type "+type+" specified.");
	        }
    	}
    	...
    	{
    		throw new OpenDESIGNERValueException("Unexpected conversion error while converting value ["+toString()+"] to an Integer", e);
    	}
    }

    public BigDecimal getBigNumber(Object object) throws OpenDESIGNERValueException
    {
        if (object==null) // NULL 
        {
            return null;
    ...
    public Boolean getBoolean(Object object) throws OpenDESIGNERValueException
    {
        if (object==null) // NULL 
        {
            return null;
        ...
        case TYPE_DATE:
            throw new OpenDESIGNERValueException(toString()+" : I don't know how to convert date values to booleans.");
        case TYPE_BINARY:
            throw new OpenDESIGNERValueException(toString()+" : I don't know how to convert binary values to booleans.");
        case TYPE_SERIALIZABLE:
            throw new OpenDESIGNERValueException(toString()+" : I don't know how to convert serializable values to booleans.");
        default:
            throw new OpenDESIGNERValueException(toString()+" : Unknown type "+type+" specified.");
        }
    }
    
    public Date getDate(Object object) throws OpenDESIGNERValueException
    {
        if (object==null) // NULL 
        {
            return null;
        ...
        case TYPE_BOOLEAN:
            throw new OpenDESIGNERValueException(toString()+" : I don't know how to convert a boolean to a date.");
        case TYPE_BINARY:
            throw new OpenDESIGNERValueException(toString()+" : I don't know how to convert a binary value to date.");
        case TYPE_SERIALIZABLE:
            throw new OpenDESIGNERValueException(toString()+" : I don't know how to convert a serializable value to date.");
    ...
    public byte[] getBinary(Object object) throws OpenDESIGNERValueException
    {
        if (object==null) // NULL 
        {
            return null;
        ...
        case TYPE_DATE:
            throw new OpenDESIGNERValueException(toString()+" : I don't know how to convert a date to binary.");
        case TYPE_STRING:
            switch(storageType)
            {
        ...
        case TYPE_NUMBER:
            throw new OpenDESIGNERValueException(toString()+" : I don't know how to convert a number to binary.");
        case TYPE_INTEGER:
            throw new OpenDESIGNERValueException(toString()+" : I don't know how to convert an integer to binary.");
        case TYPE_BIGNUMBER:
            throw new OpenDESIGNERValueException(toString()+" : I don't know how to convert a bignumber to binary.");
        case TYPE_BOOLEAN:
            throw new OpenDESIGNERValueException(toString()+" : I don't know how to convert a boolean to binary.");
        case TYPE_SERIALIZABLE:
            throw new OpenDESIGNERValueException(toString()+" : I don't know how to convert a serializable to binary.");
    ...
    public byte[] getBinaryString(Object object) throws OpenDESIGNERValueException
    {
    	// If the input is a binary string, we should return the exact same binary object IF
    	// and only IF the formatting tblOoptions for the storage metadata and this object are the same.
    	//
    ...
    public void writeData(DataOutputStream outputStream, Object object) throws OpenDESIGNERFileException
    {
        try
        {
            // Is the value NULL?
            ...
            if (object!=null) // otherwise there is no point
            {
                ...
                case STORAGE_TYPE_NORMAL:
                    ...
                    default: throw new OpenDESIGNERFileException(toString()+" : Unable to serialize data type "+getType());
                    }
                    break;
                ...
                default: throw new OpenDESIGNERFileException(toString()+" : Unknown storage type "+getStorageType());
                }
            }
        }
        catch(ClassCastException e) {
        ...
        {
            throw new OpenDESIGNERFileException(toString()+" : Unable to write value data to output stream", e);
        }
        
    }
    
    public Object readData(DataInputStream inputStream) throws OpenDESIGNERFileException, OpenDESIGNEREOFException, SocketTimeoutException
    {
        try
        {
            // Is the value NULL?
            ...
            case STORAGE_TYPE_NORMAL:
                ...
                default: throw new OpenDESIGNERFileException(toString()+" : Unable to de-serialize data of type "+getType());
                }
        ...
        {
        	throw new OpenDESIGNEREOFException(e);
        }
        ...
        {
            throw new OpenDESIGNERFileException(toString()+" : Unable to read value data from input stream", e);
        }
    }
    ...
    public void writeMeta(DataOutputStream outputStream) throws OpenDESIGNERFileException
    {
        try
        {
            int type=getType();
	                ...
	                else
	                {
						...
						for (int i=0;i<index.length;i++)
						{
		                    try {
							    ...
							    default: throw new OpenDESIGNERFileException(toString()+" : Unable to serialize indexe storage type for data type "+getType());
							    }
							} catch (ClassCastException e) {
        ...
        {
            throw new OpenDESIGNERFileException(toString()+" : Unable to write value metadata to output stream", e);
        }
    }
    
    public ValueMeta(DataInputStream inputStream) throws OpenDESIGNERFileException, OpenDESIGNEREOFException
    {
        this();
            ...
            case STORAGE_TYPE_INDEXED:
	            {
	                ...
	                else
	                {
	                    ...
	                    for (int i=0;i<indexSize;i++)
	                    {
	                        ...
	                        default: throw new OpenDESIGNERFileException(toString()+" : Unable to de-serialize indexed storage type for data type "+getType());
	                        }
	                    }
	                }
	            }
        ...
        {
            throw new OpenDESIGNERFileException(toString()+" : Unable to read value metadata from input stream", e);
        }
    }
     ...
     * @throws OpenDESIGNERValueException in case there is a conversion error (only thrown in case of lazy conversion)
     */
    public boolean isNull(Object data) throws OpenDESIGNERValueException
    {
		try{
	        Object value = data;
     ...
     * @throws OpenDESIGNERValueException In case we get conversion errors
     */
    public int compare(Object data1, Object data2) throws OpenDESIGNERValueException
    {
        ...
        case TYPE_BINARY:
            ...
            break;
        default: 
            throw new OpenDESIGNERValueException(toString()+" : Comparing values can not be done with data type : "+getType());
        }
     ...
     * @throws OpenDESIGNERValueException In case we get conversion errors
     */
    public int compare(Object data1, ValueMetaInterface meta2, Object data2) throws OpenDESIGNERValueException
    {
		if (meta2==null) {
			throw new OpenDESIGNERValueException(toStringMeta()+" : Second meta data (meta2) is null, please check one of the previous steps.");
		}
    	...
    	try
    	{
	        ...
	        if (getType()==meta2.getType()) 
	        {
	        	...
	        	case STORAGE_TYPE_INDEXED       : 
	            	...
	            	default: 
	            		throw new OpenDESIGNERValueException(meta2.toStringMeta()+" : Unknown storage type : "+meta2.getStorageType());
	        		
	        		}
	        	default: throw new OpenDESIGNERValueException(toStringMeta()+" : Unknown storage type : "+getStorageType());
	        	}
	        }
    	...
    	{
    		throw new OpenDESIGNERValueException(toStringMeta()+" : Unable to compare with value ["+meta2.toStringMeta()+"]", e);
    	}
    }
     ...
     * @throws OpenDESIGNERValueException in case there is a data conversion error
     */
    public Object convertData(ValueMetaInterface meta2, Object data2) throws OpenDESIGNERValueException
    {
        switch(getType())
        {
        ...
        default: 
            throw new OpenDESIGNERValueException(toString()+" : I can't convert the specified value to data type : "+getType());
        }
    }
     ...
     * @throws OpenDESIGNERValueException in case there is a data conversion error
     */
    public Object convertDataCompatible(ValueMetaInterface meta2, Object data2) throws OpenDESIGNERValueException
    {
        switch(getType())
        {
     ...
     * @throws OpenDESIGNERValueException in case there is a conversion error.
     */
    public Object convertDataUsingConversionMetaData(Object data2) throws OpenDESIGNERValueException {
    	if (conversionMetadata==null) {
    		throw new OpenDESIGNERValueException("API coding error: please specify the conversion metadata before attempting to convert value "+name);
    	}
        ...
        default: 
            throw new OpenDESIGNERValueException(toString()+" : I can't convert the specified value to data type : "+storageMetadata.getType());
        }
    }
     ...
     * @throws OpenDESIGNERValueException in case there is a data conversion error
     */
    public Object convertDataFromString(String pol, ValueMetaInterface convertMeta, String nullIf, String ifNull, int trim_type) throws OpenDESIGNERValueException
    {
     ...
     * @throws OpenDESIGNERValueException 
     */
    public int hashCode(Object object) throws OpenDESIGNERValueException
    {
        int hash=0;
     ...
     * @throws OpenDESIGNERValueException  case there is a data conversion problem
     */
    public Value createOriginalValue(Object data) throws OpenDESIGNERValueException
    {
       ...
       else
       {
           ...
           default: throw new OpenDESIGNERValueException(toString()+" : We can't convert data type "+getTypeDesc()+" to an original (V2) Value");
           }
       }
       return value;
    }
     ...
     * @throws OpenDESIGNERValueException  case there is a data conversion problem
     */
    public Object getValueData(Value value) throws OpenDESIGNERValueException
    {
       ...
       default: throw new OpenDESIGNERValueException(toString()+" : We can't convert original data type "+value.getTypeDesc()+" to a primitive data type");
       }
    }
