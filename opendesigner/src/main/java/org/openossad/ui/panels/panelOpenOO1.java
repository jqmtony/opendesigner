...
public class panelOpenOO1 extends PanelOpenBase implements IPanelOpenBase
{

    private static String sqlQuery ="SELECT Gname ,GRef ,GLevel ,COALESCE(GVersionNumber,'1.0') ,GDesignDate ,GUpdateDate ,ProjectID ,GVisPublic ,COALESCE(GAuthor,'') ,GId,GOrientation  FROM tblgraphs WHERE GLevel in (1,2,3) AND ProjectID=";

    public panelOpenOO1(ooOpenGenericDlg parent) {
        super();
