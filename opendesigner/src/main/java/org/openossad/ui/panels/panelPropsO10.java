...
public class panelPropsO10 extends PanelPropsBase
{
	...
	private void initialize() {
		...
		add(gui.getLblTit("Verificadores", 0, 0, 600, 30), null);
	...
	private JComponent getxjList2(int xx, int yy, int width, int height)  {
		...
		genericListModelHibernate_2 = new GenericListModelHibernate();
