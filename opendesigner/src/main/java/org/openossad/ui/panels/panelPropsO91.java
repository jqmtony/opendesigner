...
public class panelPropsO91 extends PanelPropsBase
{
	...
	private void initialize() {
		...
		add(gui.getLblTit("Medios", 0, 0, 600, 30), null);
	...
	private JComponent getxjList(int xx, int yy, int width, int height)  {
		...
		jxList = new JXList(genericListModelHibernate_2);
		genericListModelHibernate_2.connQuery = "";
		genericListModelHibernate_2.loadDataFromODBC();
