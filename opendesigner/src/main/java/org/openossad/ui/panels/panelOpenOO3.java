...
public class panelOpenOO3 extends PanelOpenBase implements IPanelOpenBase
{

    private static String sqlQuery ="SELECT Gname ,GRef ,GLevel ,COALESCE(GVersionNumber,'1.0') ,GDesignDate ,GUpdateDate ,ProjectID ,GVisPublic ,COALESCE(GAuthor,'') ,GId,GOrientation FROM tblgraphs WHERE GLevel in (8,9,10) AND ProjectID=";

    /**
     * This is the default constructor
     */
    public panelOpenOO3(ooOpenGenericDlg parent) {
        super();
